...
| ------------     | ------------     | ------------     | ------------      | ------------ | ------------  |  ------------  |  ------------  |------------  |  ------------  |
| 0.0       |Lernende können...| TN können den Begriff Forschungsdaten erläutern.| Folien | ca. Minuten   | Inhalt | TN hören zu (einatmen)    |  WL stellt organisatotisches vor. | Folien vorbereiten    | 

**Einheit 1 FDM Grundlagen in wiss. Unisammlungen** 
|  Baustein         | Lernziel         | Inhaltliches Ziel | Didaktische Methode (Arbeitsform)   | Dauer | Inhalt        | Schritt       | Regieanweisung | Materialien und Werkzeuge  |
|  ------------     | ------------     | ------------      | ------------ | ------------  |  ------------  |  ------------  |------------  |  ------------  |
...
| Baustein         | Lernziel         | Inhaltliches Ziel | Didaktische Methode (Arbeitsform)   | Dauer | Inhalt        | Schritt       | Regieanweisung | Materialien und Werkzeuge  |
|  ------------     | ------------     | ------------      | ------------ | ------------  |  ------------  |  ------------  |------------  |  ------------  |
| Lernende können die FAIR-Prinzipien benennen. (LZ-ID 01_007_0117)| TN nennen FAIR Prinzipien. |Zuruf| ca. Minuten  | Inhalt |  TN nennen (ausatmen)     |  WL stellt Frage.  | ggf. Folien vorbereiten  | 
